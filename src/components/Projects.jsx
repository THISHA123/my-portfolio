...
const projects = [
  {
    ...
    category: 'Web App',
    description: 'A full-featured Course Registration System (MERN Stack, JWT Auth). Developed with a focus on robust API integration, secure authentication workflows, and deployment readiness.',
    image: './webapp1.png',
    color: '#2563eb',
    emoji: '🎓',
  ...
  },
  {
    ...
    title: 'UniSports Hub',
    category: 'Web App',
    description: 'A modern web platform designed for university sports management. Developed focusing on the software development lifecycle, seamless event organization, and scalable data models.',
    image: './webapp2.jpeg',
    color: '#f59e0b',
    emoji: '⚽',
    tech: ['Web Platform', 'Event Management'],
    github: 'https://github.com/THISHA123/https---github.com-THISHA123-EduFlow-Registry-tree-main-frontend',
    live: '#',
    featured: true,
  },
  {
    ...
    title: 'UniMerch',
    category: 'Web App',
    description: 'A full-stack e-commerce web application (React, Spring Boot) emphasizing clean system design, scalable backend architecture, and comprehensive REST APIs.',
    image: './webapp3.png',
    color: '#10b981',
    emoji: '🛒',
    tech: ['React', 'Spring Boot', 'Full-stack'],
    github: 'https://lnkd.in/gYs9n4cf',
    live: '#',
    featured: true,
  },
  {
    ...
    title: 'CampusConnect',
    category: 'Web App',
    description: 'A full-stack lost & found platform built with careful system design. Incorporates database optimizations, secure APIs, and deployment practices for a reliable user experience.',
    image: './webapp4.png',
    color: '#8b5cf6',
    emoji: '🔍',
    tech: ['Full-stack', 'Web App', 'System Design'],
    github: 'https://github.com/THISHA123/Campus-Lost-Found',
    live: '#',
    featured: true,
  },
  {
