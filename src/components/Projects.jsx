...
const projects = [
  ...
  },
  {
    ...
    title: 'UniSports Hub',
    category: 'Web App',
    description: 'A modern web platform designed to simplify university sports management, event organization, and student engagement.',
    image: './webapp2.jpeg',
    color: '#f59e0b',
    emoji: '⚽',
  ...
  },
  {
    ...
    title: 'UniMerch',
    category: 'Web App',
    description: 'A full-stack e-commerce web application with product browsing, a shopping cart system, user authentication, and order management.',
    image: './webapp3.png',
    color: '#10b981',
    emoji: '🛒',
  ...
  },
  {
    ...
    title: 'CampusConnect',
    category: 'Web App',
    description: 'A full-stack lost & found platform that helps university students securely report, track, and recover lost items through a modern and user-friendly system.',
    image: './webapp4.png',
    color: '#8b5cf6',
    emoji: '🔍',
